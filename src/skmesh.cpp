...
void SkinnedMesh::ReadNodeHeirarchy(const aiNode* pNode, const glm::mat4& ParentTransform, double AnimationTime)
    {
...
void SkinnedMesh::BoneTransform(double timeInSeconds, std::vector<glm::mat4>& Transforms)
{
    ...
    ReadNodeHeirarchy(m_pScene->mRootNode, Identity, AnimationTime);
